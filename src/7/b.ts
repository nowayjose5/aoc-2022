...
const rootDirSize = computeFileSize(root);

const smallestTotalSize = Math.min(
  ...dirSizes.filter((dir) => dir >= 30000000 - (70000000 - rootDirSize))
);

console.log(smallestTotalSize);
