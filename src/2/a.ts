...
const whoWon = (playerOneShape: string, playerTwoShape: string): string => {
  if ((playerOneShape === 'Rock' && playerTwoShape === 'Scissors') ||
     (playerOneShape === 'Scissors' && playerTwoShape === 'Paper') ||
     (playerOneShape === 'Paper' && playerTwoShape === 'Rock')) {
    return 'playerOne';
  }

  if ((playerTwoShape === 'Rock' && playerOneShape === 'Scissors') ||
...
totalScore = rounds.map((round) => {
  ...
  const playerOneShape = definitions[letters.find((letter) => letter === playerOneLetter)].shape;
  const playerTwoShape = definitions[letters.find((letter) => letter === playerTwoLetter)].shape;
  const playerTwoPoints = definitions[letters.find((letter) => letter === playerTwoLetter)].points;
